...
namespace PipeLifecycleTest
{
    internal static class Program
    {
        ...
        private static int Main(string[] args)
        {
            ...
            {
                Console.Error.WriteLine("Usage: PipeLifecycleTest.exe --case PIPE-CREATE-001|PIPE-CONNECT-001");
                return 1;
            }

            string action = caseId == "PIPE-CREATE-001" ? "PipeCreate" : "PipeConnect";
